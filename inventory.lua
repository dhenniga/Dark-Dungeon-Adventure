...
function draw_inventory()
	-- print(get_current_room(), mapx, mapy, 9)
...
function curr_item()
	if (item_selected == 1) spr(207, mapx + 8, mapy + 4, 1, 2)
	--lanturn
	if (item_selected == 4) spr(72, mapx + 4, mapy + 4, 2, 2)
	--sword
end
